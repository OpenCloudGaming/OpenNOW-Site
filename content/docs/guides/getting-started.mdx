...
Start with the [Troubleshooting guide](/docs/guides/troubleshooting). It provides a conservative stream profile, symptom-based checks for sign-in and launch failures, native-streamer isolation steps, local reset instructions, and a checklist for useful bug reports.
