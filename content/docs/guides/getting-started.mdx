...
| Nintendo Switch | [OpenNOW-Switch `.nro`](https://github.com/OpenCloudGaming/OpenNOW-Switch/releases/latest) | Native Horizon OS homebrew client for modded Switch systems with controller-first catalog browsing and WebRTC streaming |
