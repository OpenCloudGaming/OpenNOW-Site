...
OpenNOW is an open-source GeForce NOW client. These docs cover the Electron desktop app and the native [OpenNOW-Switch](/docs/guides/nintendo-switch) homebrew client, including installation, streaming, settings, input, and troubleshooting.
...
<Steps>
  ...
  <Step>
    **Install** the artifact for your platform: Windows `.exe`, macOS `.dmg`/`.zip`, Linux `.AppImage`/`.deb`, Nintendo Switch `SwitchNOW.nro`, or the iOS TestFlight beta.
  </Step>
  <Step>
