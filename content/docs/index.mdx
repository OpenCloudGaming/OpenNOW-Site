...
For modded Nintendo Switch systems, [OpenNOW-Switch](https://github.com/OpenCloudGaming/OpenNOW-Switch) is a native Horizon OS homebrew client with controller-first catalog browsing and WebRTC streaming. Install the latest `.nro` from [OpenNOW-Switch Releases](https://github.com/OpenCloudGaming/OpenNOW-Switch/releases/latest).
