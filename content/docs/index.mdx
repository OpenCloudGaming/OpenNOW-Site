...
For modded Nintendo Switch systems, [OpenNOW-Switch](https://github.com/OpenCloudGaming/OpenNOW-Switch) is a native Horizon OS homebrew prototype. It includes the app scaffold and parts of the GFN protocol flow, but streaming is not implemented yet.
