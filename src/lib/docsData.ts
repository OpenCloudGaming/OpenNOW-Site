...
export const gstreamerRuntimeStrategies: GStreamerRuntimeStrategy[] = [
  ...
  },
  {
    ...
    referenceStrategy:
      'Embedded FFI inside the app bundle; v1.0.1 Apple Silicon packages are Developer ID–signed, notarized, and stapled. Historical v1.0.0 packages were not notarized (Gatekeeper Open Anyway)',
    releaseBehavior: 'DMG or ZIP installs to Applications; Intel Macs are not included',
    artifacts: '`OpenNOW-Qt-…-Darwin-arm64.dmg`, `.zip`',
  },
];
