...
| `keyboardLayout` | `KeyboardLayout` | `"en-US"` | GFN session keyboard layout used by the server to interpret virtual-key input; macOS maps English US/UK to `m-us`/`m-brit` |
